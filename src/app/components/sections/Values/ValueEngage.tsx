  ...
  return (
    <SectionWrapper id="healthcare-engagement">
      <div className="py-2 px-6 scrollbar-modern relative">
        ...
        <div
          className="py-8 px-4 sm:py-12 sm:px-8 md:py-16 md:px-16 scrollbar-modern"
          style={{
          ...
          <div className="max-w-2xl sm:max-w-4xl md:max-w-5xl lg:max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="text-left mb-8 lg:mb-0">
                <h1
                  className="font-bold leading-tight break-words text-balance"
                  style={{
                    fontSize: "clamp(1.5rem, 2.8vw, 2.75rem)", // smaller, more responsive
                    lineHeight: "1.2",
                  }}
                >
